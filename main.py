...
def registrar_mascota():
    ...
    salud = input("Salud de la mascota : ").strip().lower()
    ...
    if tipo == "perro":
        ...
        print("Tipo de mascosta no reconocido")
        return
    return mascota
...
def registrar_venta(clientes, inventario):
    ...
    if productos:
        ...
        print("No se ha registrado productos para la venta")
...
def mostrar_menu():
    ...
    print("6. Mostrar informacion acerca de Cliente")
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("Saliendo del sistemas ¡Gracias por usar Patas Felices App!")
            break
        else:
